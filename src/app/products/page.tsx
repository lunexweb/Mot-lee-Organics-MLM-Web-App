...
export default function ProductsPage() {
  ...
  // Gate access: only active distributors can view/buy (Phase 1 minimal gating)
    ...
    <div className="min-h-screen bg-gray-50 overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center justify-between gap-2 py-3">
            <div className="flex items-center min-w-0">
              <Link href="/dashboard" className="flex items-center text-gray-600 hover:text-gray-900 mr-3 text-sm whitespace-nowrap">
            ...
            <div className="flex items-center space-x-3 flex-shrink-0">
              ...
              <button
                ...
                className="flex items-center text-gray-600 hover:text-gray-900 whitespace-nowrap text-sm"
              >
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Premium organic skincare products for healthy, glowing skin</p>
        </div>
